...
const AdminDataPengembalian = () => {
    ...
    useEffect(() => {
        const fetch = async () =>{
            const res = await axios.get(`${url_api}/pengembalian-buku/list-all?search_query=${keyword}&page=${page}&limit=${limit}`)
        ...
        <>
            ...
            <Container style={{marginTop: '3%'}}>
                <Card>
                    ...
                    <p>Buku yang telah di kembalikan oleh anggota perpustakaan</p><Divider />
...
export default AdminDataPengembalian